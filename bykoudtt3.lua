...
Library.Sections.__index =
Library.Sections
Library.Pages.__index =
Library.Pages
local Keys = {
...
for Index, Value in
    ...
    local Tween = { } do
        ...
        Info = Info or TweenInfo.new(Library.Tween.Time,
        Library.Tween.Style,
    ...
    elseif Item:IsA("UIStroke") then
        return { "Transparency" } end
    end
    Tween.FadeItem = function(self, Item, Property, Visibility, Speed)
    local Item = Item or self.Item
    local OldTransparency = Item[Property]
    Item[Property] = Visibility and 1 or OldTransparency
    local NewTween = Tween:Create(Item, TweenInfo.new(Speed or
    Library.Tween.Time,
    Library.Tween.Style,
    Library.Tween.Direction), {
...
Library.Theme["Outline"]}):AddToTheme({BackgroundColor3 = 'Outline'})Items["Top"] = Instances:Create("Frame", { Parent = Items["Sidebar"].Instance, Size = UDim2New(1, 0, 0, 70), BackgroundTransparency = 1 })Items["Title"] = Instances:Create("TextLabel", {Parent = Items["Top"].Instance, FontFace =
Library.Font, TextColor3 =
Library.Theme["Text"],Text = Window.Name, Position = UDim2New(0, 20, 0, 18), TextSize = 18, BackgroundTransparency = 1, AutomaticSize = Enum.AutomaticSize.X}):AddToTheme({TextColor3 = 'Text'})Items["Subtitle"] = Instances:Create("TextLabel", {Parent = Items["Top"].Instance, FontFace =
Library.Font, TextColor3 =
Library.Theme["Accent"],Text = Window.SubName, Position = UDim2New(0, 20, 0, 38), TextSize = 12, BackgroundTransparency = 1, AutomaticSize = Enum.AutomaticSize.X}):AddToTheme({TextColor3 = 'Accent'})Items["Pages"] = Instances:Create("ScrollingFrame", {Parent = Items["Sidebar"].Instance, Position = UDim2New(0, 10, 0, 80), Size = UDim2New(1, -20, 1, -90),BackgroundTransparency = 1, ScrollBarThickness = 0, CanvasSize = UDim2New(0,0,0,0), AutomaticCanvasSize = Enum.AutomaticSize.Y})Instances:Create("UIListLayout", { Parent = Items["Pages"].Instance, Padding = UDimNew(0, 6), SortOrder = Enum.SortOrder.LayoutOrder })Items["Content"] = Instances:Create("Frame", {Parent = Items["MainFrame"].Instance, Position = UDim2New(0, 205, 0, 15),Size = UDim2New(1, -220, 1, -30), BackgroundTransparency = 1})Window.Items = Itemsendlocal Debounce = falsefunction Window:SetOpen(Bool)if Debounce then
return endWindow.IsOpen = BoolDebounce = trueItems["MainFrame"].Instance.Visible = BoolDebounce = falseendLibrary:Connect(UserInputService.InputBegan, function(Input)if tostring(Input.KeyCode) ==
Library.MenuKeybind thenWindow:SetOpen(not Window.IsOpen)endend)Window:SetOpen(true)return setmetatable(Window, Library)endLibrary.Page = function(self, Data)local Page = { Window = self, Name = Data.Name or "Page", Active = false, Items = {} }local Items = { } doItems["Button"] = Instances:Create("TextButton", {Parent = Page.Window.Items["Pages"].Instance, Size = UDim2New(1, 0, 0, 36),BackgroundTransparency = 1, Text = "", AutoButtonColor = false})local Bg = Instances:Create("Frame", {Parent = Items["Button"].Instance, Size = UDim2New(1, 0, 1, 0),BackgroundColor3 =
Library.Theme["Element"], BackgroundTransparency = 1, BorderSizePixel = 0}):AddToTheme({BackgroundColor3 = 'Element'})Instances:Create("UICorner", { Parent = Bg.Instance, CornerRadius = UDimNew(0, 6) })local Tx = Instances:Create("TextLabel", {Parent = Items["Button"].Instance, FontFace =
Library.Font, TextColor3 =
Library.Theme["Text"],Text = Page.Name, Position = UDim2New(0, 12, 0, 0), Size = UDim2New(1, -12, 1, 0), TextSize = 14,TextXAlignment = Enum.TextXAlignment.Left, BackgroundTransparency = 1, TextTransparency = 0.4}):AddToTheme({TextColor3 = 'Text'})Items["PageFrame"] = Instances:Create("ScrollingFrame", {Parent =
Library.UnusedHolder.Instance, Size = UDim2New(1, 0, 1, 0),BackgroundTransparency = 1, ScrollBarThickness = 2, ScrollBarImageColor3 =
Library.Theme["Accent"],CanvasSize = UDim2New(0,0,0,0), AutomaticCanvasSize = Enum.AutomaticSize.Y, Visible = false}):AddToTheme({ScrollBarImageColor3 = 'Accent'})Instances:Create("UIListLayout", { Parent = Items["PageFrame"].Instance, Padding = UDimNew(0, 12), SortOrder = Enum.SortOrder.LayoutOrder })Page.Items = ItemsPage.Bg = BgPage.Tx = Txendfunction Page:Turn(Bool)Page.Active = BoolItems["PageFrame"].Instance.Visible = BoolItems["PageFrame"].Instance.Parent = Bool and Page.Window.Items["Content"].Instance or
Library.UnusedHolder.Instanceif Bool thenPage.Bg:Tween(nil, {BackgroundTransparency = 0})Page.Tx:Tween(nil, {TextTransparency = 0})elsePage.Bg:Tween(nil, {BackgroundTransparency = 1})Page.Tx:Tween(nil, {TextTransparency = 0.4})endendItems["Button"]:Connect("MouseButton1Down", function()for _, v in Page.Window.Pages do v:Turn(v == Page) endend)if #Page.Window.Pages == 0 then Page:Turn(true) endTableInsert(Page.Window.Pages, Page)return setmetatable(Page,
Library.Pages)endLibrary.Pages.Section = function(self, Data)local Section = { Window = self.Window, Page = self, Name = Data.Name or "Section", Items = {} }local Items = { } doItems["Outer"] = Instances:Create("Frame", {Parent = Section.Page.Items["PageFrame"].Instance, Size = UDim2New(1, 0, 0, 40),BackgroundColor3 =
Library.Theme["Outline"], BorderSizePixel = 0, AutomaticSize = Enum.AutomaticSize.Y}):AddToTheme({BackgroundColor3 = 'Outline'})Instances:Create("UICorner", { Parent = Outer.Instance, CornerRadius = UDimNew(0, 6) })Items["Inner"] = Instances:Create("Frame", {Parent = Items["Outer"].Instance, Position = UDim2New(0, 1, 0, 1), Size = UDim2New(1, -2, 1, -2),BackgroundColor3 =
Library.Theme["Inline"], BorderSizePixel = 0, AutomaticSize = Enum.AutomaticSize.Y}):AddToTheme({BackgroundColor3 = 'Inline'})Instances:Create("UICorner", { Parent = Items["Inner"].Instance, CornerRadius = UDimNew(0, 6) })Items["Container"] = Instances:Create("Frame", {Parent = Items["Inner"].Instance, Position = UDim2New(0, 12, 0, 12), Size = UDim2New(1, -24, 1, -24),BackgroundTransparency = 1, AutomaticSize = Enum.AutomaticSize.Y})Instances:Create("UIListLayout", { Parent = Items["Container"].Instance, Padding = UDimNew(0, 10), SortOrder = Enum.SortOrder.LayoutOrder })-- Título da Seção separado de forma minimalistalocal Title = Instances:Create("TextLabel", {Parent = Items["Container"].Instance, FontFace =
Library.Font, TextColor3 =
Library.Theme["Accent"],Text = Section.Name:upper(), TextSize = 11, BackgroundTransparency = 1, AutomaticSize = Enum.AutomaticSize.XY}):AddToTheme({TextColor3 = 'Accent'})endSection.Container = Items["Container"]return setmetatable(Section,
Library.Sections)endLibrary.Sections.Toggle = function(self, Data)local Toggle = { Flag = Data.Flag or Library:NextFlag(), Callback = Data.Callback or function() end, Value = false }local Items = { } doItems["Button"] = Instances:Create("TextButton", {Parent = self.Container.Instance, Size = UDim2New(1, 0, 0, 24), BackgroundTransparency = 1, Text = ""})Items["Label"] = Instances:Create("TextLabel", {Parent = Items["Button"].Instance, FontFace =
Library.Font, TextColor3 =
Library.Theme["Text"],Text = Data.Name or "Toggle", TextSize = 14, TextXAlignment = Enum.TextXAlignment.Left, BackgroundTransparency = 1, Size = UDim2New(1, -40, 1, 0)}):AddToTheme({TextColor3 = 'Text'})Items["Frame"] = Instances:Create("Frame", {Parent = Items["Button"].Instance, Position = UDim2New(1, -36, 0, 3), Size = UDim2New(0, 36, 0, 18),BackgroundColor3 =
Library.Theme["Element"], BorderSizePixel = 0}):AddToTheme({BackgroundColor3 = 'Element'})Instances:Create("UICorner", { Parent = Items["Frame"].Instance, CornerRadius = UDimNew(1, 0) })Items["Stroke"] = Instances:Create("UIStroke", { Parent = Items["Frame"].Instance, Color =
Library.Theme["Outline"] }):AddToTheme({Color = 'Outline'})Items["Dot"] = Instances:Create("Frame", {Parent = Items["Frame"].Instance, Position = UDim2New(0, 3, 0, 3), Size = UDim2New(0, 12, 0, 12),BackgroundColor3 = FromRGB(150, 150, 150), BorderSizePixel = 0})Instances:Create("UICorner", { Parent = Items["Dot"].Instance, CornerRadius = UDimNew(1, 0) })endfunction Toggle:Set(Value)Toggle.Value = ValueLibrary.Flags[Toggle.Flag] = Valueif Value thenItems["Dot"]:Tween(nil, {Position = UDim2New(0, 21, 0, 3), BackgroundColor3 =
Library.Theme.Accent})Items["Stroke"]:Tween(nil, {Color =
Library.Theme.Accent})elseItems["Dot"]:Tween(nil, {Position = UDim2New(0, 3, 0, 3), BackgroundColor3 = FromRGB(140, 140, 140)})Items["Stroke"]:Tween(nil, {Color =
Library.Theme.Outline})endpcall(Toggle.Callback, Value)endItems["Button"]:Connect("MouseButton1Down", function() Toggle:Set(not Toggle.Value) end)Toggle:Set(Data.Default or false)return ToggleendLibrary.Sections.Slider = function(self, Data)local Slider = { Min = Data.Min or 0, Max = Data.Max or 100, Value = Data.Default or 0, Suffix = Data.Suffix or "", Callback = Data.Callback or function() end, Flag = Data.Flag or Library:NextFlag() }local Items = { } doItems["Main"] = Instances:Create("Frame", { Parent = self.Container.Instance, Size = UDim2New(1, 0, 0, 38), BackgroundTransparency = 1 })Items["Label"] = Instances:Create("TextLabel", {Parent = Items["Main"].Instance, FontFace =
Library.Font, TextColor3 =
Library.Theme["Text"],Text = Data.Name or "Slider", TextSize = 14, TextXAlignment = Enum.TextXAlignment.Left, BackgroundTransparency = 1, Size = UDim2New(1, 0, 0, 16)}):AddToTheme({TextColor3 = 'Text'})Items["ValLabel"] = Instances:Create("TextLabel", {Parent = Items["Main"].Instance, FontFace =
Library.Font, TextColor3 =
Library.Theme["Accent"],Text = tostring(Slider.Value)..Slider.Suffix, TextSize = 13, TextXAlignment = Enum.TextXAlignment.Right, BackgroundTransparency = 1, Size = UDim2New(1, 0, 0, 16)}):AddToTheme({TextColor3 = 'Accent'})Items["Bar"] = Instances:Create("TextButton", {Parent = Items["Main"].Instance, Position = UDim2New(0, 0, 0, 24), Size = UDim2New(1, 0, 0, 6),BackgroundColor3 =
Library.Theme["Element"], BorderSizePixel = 0, Text = ""}):AddToTheme({BackgroundColor3 = 'Element'})Instances:Create("UICorner", { Parent = Items["Bar"].Instance, CornerRadius = UDimNew(1, 0) })Items["Fill"] = Instances:Create("Frame", {Parent = Items["Bar"].Instance, Size = UDim2New(0, 0, 1, 0),BackgroundColor3 =
Library.Theme["Accent"], BorderSizePixel = 0}):AddToTheme({BackgroundColor3 = 'Accent'})Instances:Create("UICorner", { Parent = Items["Fill"].Instance, CornerRadius = UDimNew(1, 0) })endlocal
function UpdateSlider(Input)local SizeX = MathClamp((Input.Position.X - Items["Bar"].Instance.AbsolutePosition.X) / Items["Bar"].Instance.AbsoluteSize.X, 0, 1)local NewValue = MathFloor(Slider.Min + ((Slider.Max - Slider.Min) * SizeX))Slider.Value = NewValueLibrary.Flags[Slider.Flag] = NewValueItems["Fill"].Instance.Size = UDim2New(SizeX, 0, 1, 0)Items["ValLabel"].Instance.Text = tostring(NewValue)..Slider.Suffixpcall(Slider.Callback, NewValue)endlocal Sliding = falseItems["Bar"]:Connect("InputBegan", function(Input)if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch thenSliding = true UpdateSlider(Input)endend)Library:Connect(UserInputService.InputChanged, function(Input)if Sliding and (Input.UserInputType == Enum.UserInputType.MouseMovement or Input.UserInputType == Enum.UserInputType.Touch) thenUpdateSlider(Input)endend)UserInputService.InputEnded:Connect(function(Input)if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then Sliding = false endend)-- Inicializar Posição Real do Slider Baseado no Defaultlocal InitRatio = (Slider.Value - Slider.Min) / (Slider.Max - Slider.Min)Items["Fill"].Instance.Size = UDim2New(MathClamp(InitRatio, 0, 1), 0, 1, 0)return SliderendLibrary.Sections.Label = function(self, Text)local Label = Instances:Create("TextLabel", {Parent = self.Container.Instance, FontFace =
    Library.Font, TextColor3 =
    Library.Theme["Text"],Text = Text, TextSize = 13, TextXAlignment = Enum.TextXAlignment.Left, BackgroundTransparency = 1,AutomaticSize = Enum.AutomaticSize.Y, Size = UDim2New(1, 0, 0, 0), TextTransparency = 0.5}):AddToTheme({TextColor3 = 'Text'})return LabelendLibrary.CreateWindow =
    Library.WindowLibrary.AddTab =
    Library.PageLibrary.Pages.AddSection =
    Library.Pages.SectionLibrary.Sections.AddToggle =
    Library.Sections.ToggleLibrary.Sections.AddSlider =
    Library.Sections.SliderLibrary.Sections.AddLabel =
    Library.Sections.Labelend-- =============================================================================-- CONFIGURAÇÕES E ESTADOS DO ESP / CHAMS-- =============================================================================local EspPlayersEnabled = truelocal EspBoxEnabled = truelocal EspChamsEnabled = truelocal MaxEspDistance = 5000-- =============================================================================-- GERENCIADOR DE INTERFACE DO USUÁRIO-- =============================================================================local Window = Library:CreateWindow({Name = "THE WALKING DEAD 3",SubName = "QA VISUALS OVERHAUL",SettingsTabEnabled = false})local SurvivorsPage = Window:AddTab("ESP Sobreviventes")local SurvivorsSection = SurvivorsPage:AddSection("Configurações Visuais")SurvivorsSection:AddToggle({Name = "Mestre Ativado (ESP Global)",Default = true,Callback = function(Value)EspPlayersEnabled = Valueend})SurvivorsSection:AddToggle({Name = "Mostrar Caixas (2D Boxes)",Default = true,Callback = function(Value)EspBoxEnabled = Valueend})SurvivorsSection:AddToggle({Name = "Mostrar Silhuetas (Chams)",Default = true,Callback = function(Value)EspChamsEnabled = Valueend})-- SLIDER DESLIZÁVEL ATUALIZADO: 0 a 10.000 MetrosSurvivorsSection:AddSlider({Name = "Distância de Renderização",Min = 0,Max = 10000,Default = 5000,Suffix = "m",Callback = function(Value)MaxEspDistance = Valueend})SurvivorsSection:AddLabel("Dica: Pressione [ K ] para fechar ou abrir este painel a qualquer momento.")local InfectedPage = Window:AddTab("ESP Infectados")local InfectedSection = InfectedPage:AddSection("Em Breve")InfectedSection:AddLabel("Módulos em desenvolvimento.")-- =============================================================================-- ENGENHARIA DO MOTOR DE RENDERIZAÇÃO (ESP BOX 2D + HEALTH + CHAMS NATIVO)-- =============================================================================local GuiParent = LocalPlayer:WaitForChild("PlayerGui")local EspGui = Instance.new("ScreenGui")EspGui.Name = "QA_ESP_Engine"EspGui.ResetOnSpawn = falseEspGui.ZIndexBehavior = Enum.ZIndexBehavior.GlobalEspGui.Parent = GuiParentlocal espElements = {}local
    function createSafeESP(player)local elements = {}local holder = Instance.new("Folder")holder.Name = "Render_" .. player.UserIdholder.Parent = EspGui-- Box Outline Externalocal box = Instance.new("Frame")box.BackgroundTransparency = 1box.BorderColor3 = Color3.fromRGB(0, 180, 216) -- Azul Cyan Premium combinando com a UIbox.BorderSizePixel = 1box.Visible = falsebox.Parent = holderelements.Box = box-- Nomelocal nameLabel = Instance.new("TextLabel")nameLabel.BackgroundTransparency = 1nameLabel.TextColor3 = Color3.fromRGB(255, 255, 255)nameLabel.TextSize = 12nameLabel.Font = Enum.Font.SourceSansBoldnameLabel.TextStrokeTransparency = 0.3nameLabel.TextXAlignment = Enum.TextXAlignment.CenternameLabel.Visible = falsenameLabel.Parent = holderelements.Name = nameLabel-- Distâncialocal distLabel = Instance.new("TextLabel")distLabel.BackgroundTransparency = 1distLabel.TextColor3 = Color3.fromRGB(240, 220, 80)distLabel.TextSize = 11distLabel.Font = Enum.Font.SourceSansBolddistLabel.TextStrokeTransparency = 0.3distLabel.TextXAlignment = Enum.TextXAlignment.CenterdistLabel.Visible = falsedistLabel.Parent = holderelements.Distance = distLabel-- Healthbarslocal barOutline = Instance.new("Frame")barOutline.BackgroundColor3 = Color3.fromRGB(0, 0, 0)barOutline.BorderSizePixel = 0barOutline.Visible = falsebarOutline.Parent = holderelements.HealthOutline = barOutlinelocal bar = Instance.new("Frame")bar.BorderSizePixel = 0bar.Visible = falsebar.Parent = holderelements.HealthBar = bar-- Elemento de Chams Nativo Otimizado (Highlight)local highlight = Instance.new("Highlight")highlight.Name = "Chams"highlight.FillColor = Color3.fromRGB(0, 180, 216)highlight.FillTransparency = 0.5highlight.OutlineColor = Color3.fromRGB(255, 255, 255)highlight.OutlineTransparency = 0.2highlight.Enabled = falsehighlight.Parent = holderelements.Highlight = highlightelements.Holder = holderespElements[player] = elementsendlocal
